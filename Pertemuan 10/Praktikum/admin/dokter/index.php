			...
			columns: [{
				...
				},
				{
					...
					render: (data, type, row) => {
						return `<a href="data.php?id=${data.id_dokter}" class="btn btn-sm btn-primary me-1" data-bs-toggle="tooltip" title="Ubah"><i class="fa fa-pencil-alt"></i></a><button class="btn btn-sm btn-danger btn-delete" data-bs-toggle="tooltip" title="Hapus" data-id="${data.id_dokter}"><i class="fa fa-trash-can"></i></button>`;
					}
				}
			],
			columnDefs: [{
